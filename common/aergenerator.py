...
class Library:
    def __init__(self):
        ...
        self.modal_radius = xr.DataArray(_modal_radius, dims=("species", "rh"), coords={"species": self._species_short,
        ...
        _stddev = [[0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3],
                   ...
                   [0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3],
                   [0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3]]
        self.stddev = xr.DataArray(_stddev, dims=("species", "rh"), coords={"species": self._species_short,
                                                                             "rh": self.relative_humidity})
        # Refractive indexes
